...
class MyNavBar extends Component {
    ...
    render() {
        ...
        const {title, leftTitle, leftImage, leftAction, rightTitle, rightImage, rightAction, style, rightTitleStyle, leftTitleStyle} = this.props;
        return (
            <ImageBackground
                    ...
                    <View style={styles.showView}>
                        {
                            leftTitle ?
                                (
                                    leftImage ?
                                        <View style={[styles.leftNav, {alignItems: 'center', flexDirection: 'row'}]}>
                                            <View style={{alignItems: 'center'}}>
                                                <Image style={{width: 23, height: 23}} source={leftImage}/>
                                            </View>
                                            <View style={{alignItems: 'center'}}>
                                                <Text style={[styles.barButton, leftTitleStyle]}>{leftTitle}</Text>
                                            </View>
                                        </View> :
