...
import ChinaArea1 from './china_area_data1.json';
...
export default class PPicker extends Component {
    ...
    static propTypes = {
        ...
        appState: AppState.currentState,//应用在前台还是在后台
    };
    ...
    componentWillUnmount() {
        AppState.removeListener('change', null);
    }
    ...
    _createAreaData = () => {
        ...
        if (!this.props.isSpecial) {
            area = ChinaArea.address;
        } else {
            area = ChinaArea1.address;
        }
